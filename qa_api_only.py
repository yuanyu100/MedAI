#!/usr/bin/env python3
"""
QA功能专用API服务器 - 解决StructuredTool object is not callable错误
"""
...
app = FastAPI(
    title="QA功能专用API服务器",
    description="解决StructuredTool object is not callable错误",
    version="1.0.0",
    lifespan=lifespan
)
...
def start_server(host: str = "0.0.0.0", port: int = 8000):
    """启动API服务器"""
    print(f"🌐 启动QA专用API服务器在 {host}:{port}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="启动QA专用API服务器")
